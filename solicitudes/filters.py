...
from dashboard.models import Inventario, Order, ArticulosOrdenados, Product, Criticidad, Distrito, Familia
...
class HistoricalInventarioFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['history_id','history_user','producto','start_date','end_date','producto']
